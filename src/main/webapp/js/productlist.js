...
$(function(){
    ...
    $(".modifyProduct").on("click",function(){
        var obj = $(this);
        window.location.href=path+"/productmodify.html?&proid="+ obj.attr("proid");
    });
    ...
    $('#yes').click(function () {
        deleteProvider(productObj);
    });

    $(".deleteProduct").on("click",function(){
        productObj = $(this);
        changeDLGContent("你确定要删除商品【"+productObj.attr("proname")+"】吗？");
        openYesOrNoDLG();
    });
});