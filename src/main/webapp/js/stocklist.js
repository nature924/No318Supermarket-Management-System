...
$(function(){
    ...
    $(".modifyStock").on("click",function(){
        var obj = $(this);
        window.location.href=path+"/stockmodify.html?&proid="+ obj.attr("proid");
    });
    ...
    $('#yes').click(function () {
        deleteProvider(stockObj);
    });

    $(".deleteStock").on("click",function(){
        stockObj = $(this);
        changeDLGContent("你确定要删除商品【"+stockObj.attr("proname")+"】吗？");
        openYesOrNoDLG();
    });
});